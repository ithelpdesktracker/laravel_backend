                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <p>Room: {{$room_num}}</p>
                                            <p>Issue Type: {{$iss_type}}</p>
                                            <p>Issue Description: {{$iss_description}}</p>
                                            <br/>
                                            <p>Click on Resolved/Unresolved and type your description in the body of the email.</p>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">NJIT MTSS, 323 Dr Martin Luther King Jr Blvd, Newark, NJ 07102</span>
                                </td>
                            </tr>
                        </table>
                    </div>
